      ...
      <div className="h-16 flex items-center px-4 border-b border-slate-700/50">
        <div className="flex items-center gap-1">
          <img 
            ...
            alt="FIFA Trophy" 
            className="w-14 h-12 object-contain scale-x-[1.4] scale-y-100 -mr-1 -ml-1" 
            style={{ mixBlendMode: 'screen' }} 
          />
          <span className="font-bold text-lg tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400 relative z-10 ml-2">STADIUM OS</span>
        </div>
      </div>
