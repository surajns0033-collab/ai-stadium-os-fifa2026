...
export default function DigitalTwinMap() {
  ...
  return (
    <div className="absolute inset-0 bg-black flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="absolute bottom-4 right-4 z-50 w-72 pointer-events-none">
      ...
      <div className="relative w-full max-w-3xl aspect-[4/3] rounded-[120px] border-4 border-slate-800/80 bg-[#0A0015]/60 shadow-[0_0_50px_rgba(43,124,228,0.1)] flex items-center justify-center backdrop-blur-md">
        ...
        {gates.map((gate) => {
          ...
          // Simulate gate closure
          if (simulation === 'gate_closed' && gate.id === 'g4') {
            capacity = 100; // Force critical
          }
